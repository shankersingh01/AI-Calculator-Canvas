...
def analyze_image(img: Image, dict_of_vars: dict):
    ...
    prompt = (
        ...
        f"1. Simple mathematical expressions like 1 + 1, 2 + 2, 3 * 4, 5 / 6, 7 - 8, etc.: In this case, solve and return the answer in the format of a LIST OF ONE DICT [{{'expr': given expression, 'result': calculated answer}}]. "
